    ...
    return (
      <form method="post" action="/">
        <div className="jr-card">
          <h3 className="mb-0">Startup and Founder Section</h3>
          <TextField
            type="text"
        ...
        <div className="jr-card">
          <h3 className="mb-0">Details about cofounders</h3>
          <p className="text-muted">
            Add only cofounder and respective designation per line. If the
            startup has no co-founders, please specify "No co-founders" in
            Cofounder Name
          </p>
          {coFounders.map((f, i) => (
            <div key={i}>
        ...
        <div className="jr-card">
          <h3 className="mb-0">Incorporation type and legal entities</h3>
        ...
        <div className="jr-card">
          <p className="text-muted">
            If your startup is incorporated, please state the individuals who
            are formally a part of the legal entity, along with their roles. In
            case of private company, mention the directors and their types, if
        ...
        <div className="jr-card">
          <h3 className="mb-0">Funding status</h3>
          <p className="text-muted">
        ...
        <div className="jr-card">
          <h3 className="mb-0">Primary Contact Details</h3>
          <TextField
            type="text"
        ...
        <div className="jr-card">
          <h3 className="mb-0">Secondary Contact Details</h3>
          <p className="text-muted">
        ...
        <div className="jr-card">
          <h3 className="mb-0">Online identities</h3>
          <TextField
            type="text"
        ...
        <div className="jr-card">
          ...
          <p className="text-muted">
            If your startup is not incorporated, please mention "Not
            incorporated" and if your startup is incorporated but does not have
            a bank account, please mention "No Bank Account"
          </p>
          <TextField
            type="text"
            label="Startup PAN"
        ...
        <div className="jr-card  align-items-center">
          <h3 className="mb-0">Facilities Needed From GUSEC</h3>

          <FormGroup>
            <FormControlLabel
              control={
                <Checkbox
                  checked={facilitiesNeededFromGUSEC["mentorship"]}
                  value="mentorship"
                  disabled
                />
              }
            ...
            <FormControlLabel
              control={
                <Checkbox
                  checked={facilitiesNeededFromGUSEC["support_in_fundraising"]}
            ...
            <FormControlLabel
              control={
                <Checkbox
                  checked={facilitiesNeededFromGUSEC["gusec_id_card"]}
                  value="gusec_id_card"
                  disabled
                />
              }
            ...
            <FormControlLabel
              control={
                <Checkbox
                  checked={facilitiesNeededFromGUSEC["dedicated_silent_zone"]}
            ...
            <FormControlLabel
              control={
                <Checkbox
                  checked={facilitiesNeededFromGUSEC["desktop_computer_access"]}
            ...
            <FormControlLabel
              control={
                <Checkbox
                  checked={facilitiesNeededFromGUSEC["gusec_email_address"]}
            ...
            <FormControlLabel
              control={
                <Checkbox
                  checked={facilitiesNeededFromGUSEC["coworking_access"]}
          ...
          <hr />
          <h3 className="mb-0">GUSEC Premises Access</h3>
          <TextField
            type="text"
